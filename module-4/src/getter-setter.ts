...
//   }
//   //   getBalence(): number {
//   //     // console.log(`My Current Balence is ${this._balence}`);
//   //     return this._balence;
//   //   }

//   // setter
//   set deposit(amount: number) {
//     this._balence = this._balence + amount;
//   }
...
// const myAccount = new BankAccount(222, "X", 200);
// // myAccount.balence = 0;
// // console.log(myAccount);
// // console.log(myAccount.getBalence());
// console.log(myAccount.balence);
